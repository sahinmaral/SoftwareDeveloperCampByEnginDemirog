...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CarDetailListRetrieved = "Arabaların detayları getirildi";
        public static string CarListRetrieved =  "Arabalar getirildi";
        public static string CarIdRequired = "Arabanin Id sini girmeniz gerekir";
        public static string BrandRetrieved = "Marka bilgisi getirildi";
        public static string CarRetrieved = "Araba bilgisi getirildi";
        public static string ColourRetrieved = "Renk bilgisi getirildi";
        public static string UserRetrieved = "Kullanıcı bilgisi getirildi";
        public static string CustomerRetrieved = "Müşteri bilgisi getirildi";
        public static string RentalRetrieved = "Kiralama bilgisi getirildi";
    }
}
